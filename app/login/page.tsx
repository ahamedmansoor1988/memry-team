...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left — gradient */}
      <div className="hidden lg:flex w-1/2 flex-col justify-between px-12 py-12" style={{ background: "linear-gradient(135deg, #a855f7 0%, #ec4899 50%, #f97316 100%)" }}>
        {/* White logo */}
        <svg height="28" viewBox="0 0 482 207" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "auto" }}>
        ...
        {/* Tagline */}
        <div>
          <p className="text-white/90 text-[32px] font-semibold leading-snug font-[family-name:var(--font-serif)] mb-4">
            Catch design bugs<br />before they ship.
          </p>
          <p className="text-white/60 text-[15px] leading-relaxed max-w-xs">
            Compare Figma frames against the live site. Find missing elements, wrong fonts, and color mismatches in one click.
          </p>
        </div>

        <p className="text-white/30 text-[11px]">© 2026 Loupe</p>
      </div>
