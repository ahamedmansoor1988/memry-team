          ...
          <div className="mb-5 flex items-start gap-3 rounded-xl border-2 border-amber-300 bg-amber-50 px-4 py-3.5">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-[12px] leading-relaxed text-amber-800">
                {scannerStatusCopy(result.scannerStatus ?? scannerStatus).text} Any counts below reflect a much weaker HTML-only check, not a real scan — they are not evidence the page is clean.
              </p>
            </div>
            <button
              onClick={run}
            ...
            {result?.mode === "static_fallback" ? (
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg bg-white p-3">
                  ...
                  <p className="mt-1 text-[11px] text-[#71717a]">Layout issues</p>
                </div>
                <div className="rounded-lg bg-white p-3">
