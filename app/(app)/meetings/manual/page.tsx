...
import { ChevronLeft, Video, Loader2, CheckCircle2, HelpCircle, Zap, ChevronRight } from "lucide-react";
...
export default function ManualMeetingsPage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-white">
      ...
      {/* Header */}
      <div className="px-8 pt-6 pb-5 border-b border-zinc-200 shrink-0">
        <Link href="/meetings" className="flex items-center gap-1.5 text-xs text-zinc-400 hover:text-zinc-700 transition-colors mb-3">
          <ChevronLeft size={13} /> Meetings
        </Link>
        <h1 className="text-xl font-semibold text-zinc-900">Paste transcript</h1>
        <p className="text-sm text-zinc-400 mt-0.5">Extract decisions and action items from any transcript</p>
      </div>
